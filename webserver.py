		...
		try:
			if self.path.endswith("/restaurants"):
				...
				for restaurant in restaurants:
					...
					output += "</br>"
					output += "<a href='/restaurants/%s/rename'>Rename</a>" % restaurant.id
					output += "</br>"
			...
			if self.path.endswith("/rename"):
				...
				if myRestaurantQuery != []:
					...
					output += "<form method = 'POST' enctype = 'multipart/form-data' action = '/restaurants/%s/rename'>"\
								% restaurantIDPath
					output += "<input name='newRestaurantName' type='text' placeholder='Restaurant Name'>"
